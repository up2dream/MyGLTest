...
abstract class BasicTexture implements Texture {
	...
	protected BasicTexture(final IGLCanvas canvas, final int id, final int state) {
	...
	@Override
	public void draw(final IGLCanvas canvas, final int x, final int y) {
	...
	protected void setAssociatedCanvas(final IGLCanvas canvas) {
		mCanvasRef = canvas;
	}
